...
func (u *User) GetPrimaryKeyStringValue() (string, error) {
	...
	if err != nil {
		return "", errors.Newf(mapping.ClassFieldValue, "invalid primary field value: %v to parse string. Err: %v", u.ID, err)
	}
...
func (u *User) ParseFieldsStringValue(field *mapping.StructField, value string) (interface{}, error) {
	...
	case 0: // ID
		temp := u.ID
		if err := u.ID.UnmarshalText([]byte(value)); err != nil {
			return "", errors.Newf(mapping.ClassFieldValue, "invalid field 'ID' value: '%v' to parse string. Err: %v", u.ID, err)
		}
	...
	case 1: // CreatedAt
		...
		if err := u.CreatedAt.UnmarshalText([]byte(value)); err != nil {
			return "", errors.Newf(mapping.ClassFieldValue, "invalid field 'CreatedAt' value: '%v' to parse string. Err: %v", u.CreatedAt, err)
		}
	...
	case 2: // DeletedAt
		...
		if err := temp.UnmarshalText([]byte(value)); err != nil {
			return "", errors.Newf(mapping.ClassFieldValue, "invalid field 'DeletedAt' value: '%v' to parse string. Err: %v", u.DeletedAt, err)
		}
	...
	case 5: // IntArray
		return strconv.ParseInt(value, 10, mapping.IntegerBitSize)
	case 6: // Bytes
		return "", errors.New(mapping.ClassFieldNotParser, "field 'Bytes' doesn't have string setter.")
	case 7: // PtrBytes
		return "", errors.New(mapping.ClassFieldNotParser, "field 'PtrBytes' doesn't have string setter.")
	case 8: // Wrapped
		return strconv.ParseInt(value, 10, mapping.IntegerBitSize)
	case 9: // PtrWrapped
		return strconv.ParseInt(value, 10, mapping.IntegerBitSize)
...
func (u *User) SetRelationModel(relation *mapping.StructField, model mapping.Model) error {
	...
	case 10: // External
		...
		return errors.Newf(mapping.ClassInvalidRelationValue, "provided invalid model value: '%T' for relation External", model)
	default:
