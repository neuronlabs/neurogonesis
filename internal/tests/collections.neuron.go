...
func (c *carsQueryBuilder) Select(fields ...string) *carsQueryBuilder {
	...
	for _, field := range fields {
		...
		if !ok {
			c.err = errors.Newf(mapping.ClassInvalidModelField, "field: '%s' is not valid for model: '_Cars'", field)
			return c
		}
...
func (c *carsQueryBuilder) OrderBy(fields ...string) *carsQueryBuilder {
	...
	for i, field := range fields {
		if len(field) == 0 {
			c.err = errors.New(mapping.ClassInvalidModelField, "cannot set sorting order for an empty field for model: '_Cars'")
			return c
		}
...
func (u *_Users) GetFavoriteCar(ctx context.Context, db database.DB, model *User, relationFieldset ...string) (*Car, error) {
	...
	if model.IsPrimaryKeyZero() {
		return nil, errors.New(mapping.ClassFieldValue, "model's: 'User' primary key value has zero value")
	}
	...
	if len(relationFieldset) == 0 {
		...
		for _, field := range relationFieldset {
			...
			if !ok {
				return nil, errors.Newf(mapping.ClassInvalidModelField, "no field: '%s' found for the model: 'Car'", field)
			}
...
func (u *_Users) SetFavoriteCar(ctx context.Context, db database.DB, model *User, relation *Car) error {
	...
	// Check if primary key has zero value.
	if model.IsPrimaryKeyZero() {
		return errors.New(mapping.ClassFieldValue, "model's: 'User' primary key value has zero value")
	}
	relationField, err := u.Model.RelationByIndex(11)
	if err != nil {
		return err
	...
	if relation.IsPrimaryKeyZero() {
		return errors.New(mapping.ClassFieldValue, "relation 'FavoriteCar' model has zero value primary field")
	}
...
func (u *_Users) SetCars(ctx context.Context, db database.DB, model *User, relations ...*Car) error {
	...
	for i, relation := range relations {
		if relation.IsPrimaryKeyZero() {
			return errors.New(mapping.ClassFieldValue, "one of relation 'Cars' model has zero value primary field")
		}
...
func (u *_Users) GetSons(ctx context.Context, db database.DB, model *User, relationFieldset ...string) ([]*User, error) {
	...
	if len(relationFieldset) == 0 {
		...
		for _, field := range relationFieldset {
			sField, ok := relationModel.FieldByName(field)
			if !ok {
				return nil, errors.Newf(mapping.ClassInvalidModelField, "no field: '%s' found for the model: 'User'", field)
			}
			fields = append(fields, sField)
		}
	}
...
func (u *_Users) SetSons(ctx context.Context, db database.DB, model *User, relations ...*User) error {
	...
	for i, relation := range relations {
		if relation.IsPrimaryKeyZero() {
			return errors.New(mapping.ClassFieldValue, "one of relation 'Sons' model has zero value primary field")
		}
		relationModels[i] = relation
	}
	relationSetter, ok := db.(database.QueryRelationSetter)
...
func (u *_Users) SetSister(ctx context.Context, db database.DB, model *User, relation *User) error {
	...
	q := query.NewScope(u.Model, model)
	if relation.IsPrimaryKeyZero() {
		return errors.New(mapping.ClassFieldValue, "relation 'Sister' model has zero value primary field")
	}
	relationSetter, ok := db.(database.QueryRelationSetter)
	if !ok {
		return errors.NewDetf(query.ClassInternal, "DB doesn't implement QueryRelationSetter interface: %T", db)
...
func (u *_Users) GetExternal(ctx context.Context, db database.DB, model *User, relationFieldset ...string) (*external.Model, error) {
	...
	if len(relationFieldset) == 0 {
		...
		for _, field := range relationFieldset {
			sField, ok := relationModel.FieldByName(field)
			if !ok {
				return nil, errors.Newf(mapping.ClassInvalidModelField, "no field: '%s' found for the model: 'external.Model'", field)
			}
			fields = append(fields, sField)
		}
	}
...
func (u *_Users) SetExternal(ctx context.Context, db database.DB, model *User, relation *external.Model) error {
	...
	q := query.NewScope(u.Model, model)
	if relation.IsPrimaryKeyZero() {
		return errors.New(mapping.ClassFieldValue, "relation 'External' model has zero value primary field")
	}
	relationSetter, ok := db.(database.QueryRelationSetter)
	if !ok {
		return errors.NewDetf(query.ClassInternal, "DB doesn't implement QueryRelationSetter interface: %T", db)
...
func (u *usersQueryBuilder) Select(fields ...string) *usersQueryBuilder {
	...
	for _, field := range fields {
		...
		if !ok {
			u.err = errors.Newf(mapping.ClassInvalidModelField, "field: '%s' is not valid for model: '_Users'", field)
			return u
		}
		fieldSet = append(fieldSet, structField)
	}
...
func (u *usersQueryBuilder) OrderBy(fields ...string) *usersQueryBuilder {
	...
	for i, field := range fields {
		if len(field) == 0 {
			u.err = errors.New(mapping.ClassInvalidModelField, "cannot set sorting order for an empty field for model: '_Users'")
			return u
		}
		var order query.SortOrder
		if field[0] == '-' {
