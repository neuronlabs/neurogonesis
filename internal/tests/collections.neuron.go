...
func (u *users) Query(db orm.DB, models ...*User) *usersQueryBuilder {
...
func (u *users) QueryCtx(ctx context.Context, db orm.DB, models ...*User) *usersQueryBuilder {
	var queryModels []mapping.Model
	if len(models) > 0 {
		queryModels = make([]mapping.Model, len(models))
		for i, model := range models {
...
func (c *cars) Query(db orm.DB, models ...*Car) *carsQueryBuilder {
	var queryModels []mapping.Model
	if len(models) > 0 {
		queryModels = make([]mapping.Model, len(models))
		for i, model := range models {
...
func (c *cars) QueryCtx(ctx context.Context, db orm.DB, models ...*Car) *carsQueryBuilder {
	var queryModels []mapping.Model
	if len(models) > 0 {
		queryModels = make([]mapping.Model, len(models))
		for i, model := range models {
